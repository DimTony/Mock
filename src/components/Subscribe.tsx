...
const subscriptionPlans = [
  {
    ...
    price: "$9.99/month",
    features: ["Basic mobile encryption", "30 day duration"],
  },
  {
    id: "mobile-v4-premium",
    name: "Mobile Only v4 - Premium",
    price: "$19.99/month",
    features: ["Premium mobile encryption", "60 day duration"],
  },
  {
    id: "mobile-v4-enterprise",
    name: "Mobile Only v4 - Enterprise",
    price: "$49.99/month",
    features: ["Mobile Only", "90 day duration"],
  },
  {
    id: "mobile-v5-basic",
    name: "Mobile Only v5 - Basic",
    price: "$49.99/month",
    features: ["v5 Mobile Only", "60 day duration"],
  },
  {
    id: "full-suite-basic",
    name: "Full Suite - Basic",
    price: "$49.99/month",
    features: ["v4 Full Suite", "60 day duration"],
  },
  {
    id: "full-suite-premium",
    name: "Full Suite - Premium",
    price: "$49.99/month",
    features: ["v5 Full Suite", "90 day duration"],
  },
];
